...
def gameover(window,x,y,score,pdir,fpos):
	...
	fpos = (random.randint(0,(grid_max / grid_size) - 1) * grid_size,random.randint(0,(grid_max / grid_size) - 1) * grid_size)
	score = 0
	pdir = 1
...
def main():
	...
	while True:
		...
		score_dis = pygame.font.SysFont('Arial',48).render(str(score),True,(255,255,0))
